...
serverSocket.bind(('10.52.108.74', serverPort))
...
while True:
	...
	try:
		...
		#filepath = r'C:\Users\olahe\Desktop\V19\KTN\Lab2-HTTPServer-students\Lab2-HTTPServer-students\HelloWorld.html'
		...
		connectionSocket.send(rb"<html><head></head><body><h1>404 Not Found</h1></body></html>\r\n")
